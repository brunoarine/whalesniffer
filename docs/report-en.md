# Automatic detection of Eubalaena whales in aerial images

Completion project of the Digital Image Processing discipline of the Postgraduate Program in Environmental Sciences, 2nd semester of 2015, by Bruno Arine.

## Abstract

The North Atlantic Right Whale (Eubalenae glacialis) is currently represented by no more than 500 individuals in natural habitat. Thus, obtaining information about the health and conditions of each individual is urgent so that preservation entities, together with the scientific community, are able to protect them from extinction. To track and monitor the population, right whales are photographed by aerial survey and manually compared to an online photo-identification catalogue. The identification process takes time, making individual tracking difficult for biological sampling, acoustic recording, and various relevant medical assessments. Currently, there are a limited number of professionals able to visually identify each individual present in the photos when they emerge. The present work proposes an automatic method of locating right whales in aerial images, so that later the head region can be identified, where the most relevant features for recognition between individuals are found. Thus, the composition of training material for a potential neural network for recognizing individuals, with the region of greatest interest in each photo, becomes less laborious and with minimized interference from a human operator.
